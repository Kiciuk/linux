...
struct q6core {
	...
	enum q6core_version adsp_avs_version;
};
...
static int q6core_callback(struct apr_device *adev, struct apr_resp_pkt *data)
{
	...
	case AVCS_CMDRSP_GET_FWK_VERSION: {
		 ...
		 */
		core->adsp_avs_version = Q6_ADSP_VERSION_2_8;
	...
	case AVCS_GET_VERSIONS_RSP: {
		...
		for (i = 0; i < g_core->svc_version->num_services; i++) {
			...
			case AVCS_CMDRSP_Q6_ID_2_6:
				core->adsp_avs_version = Q6_ADSP_VERSION_2_6;
				break;
			case AVCS_CMDRSP_Q6_ID_2_7:
				core->adsp_avs_version = Q6_ADSP_VERSION_2_7;
				break;
...
static int q6core_probe(struct apr_device *adev)
{
	...
	g_core->adsp_avs_version = Q6_ADSP_VERSION_UNKNOWN;
	g_core->adev = adev;
