...
struct q6dsp_clk_v1 q6dsp_v1_clocks[]={
	Q6AFE_CLK_DIG_V1(LPASS_CLK_ID_INTERNAL_DIGITAL_CODEC_CORE, PRIMARY_MI2S_RX),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_PRI_MI2S_IBIT, PRIMARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_INTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_SEC_MI2S_IBIT, SECONDARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_INTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_TER_MI2S_IBIT, TERTIARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_INTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_QUAD_MI2S_IBIT, QUATERNARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_INTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_QUI_MI2S_IBIT, QUINARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_INTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_PRI_MI2S_EBIT, PRIMARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_EXTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_SEC_MI2S_EBIT, SECONDARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_EXTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_TER_MI2S_EBIT, TERTIARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_EXTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_QUAD_MI2S_EBIT, QUATERNARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_EXTERNAL),
	Q6AFE_CLK_BIT_V1(LPASS_CLK_ID_QUI_MI2S_EBIT, QUINARY_MI2S_RX, Q6AFE_LPASS_CLK_SRC_EXTERNAL),
	Q6AFE_CLK_OSR_V1(LPASS_CLK_ID_QUI_MI2S_OSR, QUINARY_MI2S_RX),
};
			  ...
			  int clk_root, unsigned int freq)
{
	...
	if (q6core_get_adsp_version() < Q6_ADSP_VERSION_2_7) {
		...
		if (IS_ERR_OR_NULL(clk_init))
			return PTR_ERR(clk_init);
